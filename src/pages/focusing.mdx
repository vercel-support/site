...
<SEO title="OmniFocus Library for AppleScript" description="Overview of Brandon Pittman's AppleScript library for OmniFocus." />
...
<div className="mt-8 flex justify-center">
  <Cta href="https://github.com/brandonpittman/omnifocus">
    Get started
  </Cta>
</div>
</Layout>
